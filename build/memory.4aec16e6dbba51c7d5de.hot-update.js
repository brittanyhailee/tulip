...
var Memory = function () {
    ...
    function fetchMemory() {
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                resolve('Memory goes here');
            }, 2000);
        });
    }
    var myButton = document.getElementById("memory-btn");
    myButton === null || myButton === void 0 ? void 0 : myButton.addEventListener("click", function () {
        fetchMemory().then(function (memory) {
            console.log(memory);
            return memory;
        });
    });
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "container" },
        ...
        isClicked && (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", null, "memory: ")
            ,
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c1a0dd84a668df9078c7")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=memory.4aec16e6dbba51c7d5de.hot-update.js.map